...
//              X- dispatch add smurf action if request is successful
//              X- dispatch an error text action if an request returns an error
//3. Add set error text action:
//              - return action object setting error text
//4. Any other actions you deem nessiary to complete application.

// Add in cases to your reducer to handle:
//      X- The start of an api call "IS_LOADING""is_loading:true"
//      X- The end of an api call "LOAD_SUCCESS" "is_loading:false, smurflist: action.payload", error: ""
//      X- The adding a smurf to the smurf list when added into payload "PUSH_DATA" "is_loading: true, error: "" "
//      X- Setting Error Text "ERROR" "is_loading:false, error: "action.payload" "
